...
import { CustomFieldGeneralTabContent } from './index'
...
describe('CustomFieldGeneralTabContent', () => {
  afterEach(() => {
  ...
  it('should show tab content', () => {
    ...
    expect(screen.getByText(customFieldsMock[0].fieldName as string)).toBeInTheDocument()
