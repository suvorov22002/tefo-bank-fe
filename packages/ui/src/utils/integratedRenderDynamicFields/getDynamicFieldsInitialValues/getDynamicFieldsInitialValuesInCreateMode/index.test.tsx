import { getDynamicFieldsInitialValuesInCreateMode } from '.'
import {
...
describe('getDynamicFieldsInitialValuesInCreateMode', () => {
  it('should return initial values for primary fields', () => {
    expect(getDynamicFieldsInitialValuesInCreateMode(dynamicFieldsTemplateMock)).toEqual({
      p1: '',
      p2: '',
    })
  })
  ...
  it('should return initial values for required custom fields', () => {
    expect(
      getDynamicFieldsInitialValuesInCreateMode({
